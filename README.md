...
-   `DATA` contains two input data files:
    ...
    **Note**: These are the only required source files. **All other datasets used in this project are automatically generated by running** `StarCLIP.ipynb`.
